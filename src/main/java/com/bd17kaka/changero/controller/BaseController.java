package com.bd17kaka.changero.controller;
...
public class BaseController {
	...
	/** 写入信息 */
	private void write(String contentType, HttpServletRequest req,
	...
	protected void writeHtml(HttpServletRequest req, HttpServletResponse resp,
			String msg) throws ServletException, IOException {
		write("text/html; charset=UTF-8", req, resp, msg);
	}

	protected void writeJavaScript(HttpServletRequest req,
			HttpServletResponse resp, String msg) throws ServletException,
			IOException {
		write("application/x-javascript; charset=\"UTF-8\"", req, resp, msg);
	}

	protected void writeJson(HttpServletRequest req, HttpServletResponse resp,
			String msg) throws ServletException, IOException {
		write("text/html; charset=\"UTF-8\"", req, resp, msg);
	}

	protected void writePlain(HttpServletRequest req, HttpServletResponse resp,
			String msg) throws ServletException, IOException {
		write("text/plain; charset=UTF-8", req, resp, msg);
	}

	protected void writeXml(HttpServletRequest req, HttpServletResponse resp,
			String msg) throws ServletException, IOException {
	 ...
	 * @return
	 */
	public static String getRequestPassport(HttpServletRequest request,
			boolean needExist) {
		String passport = (String) request.getAttribute(PassportAttKey);
		if (StringUtils.isEmpty(passport) && needExist)
			throw new RuntimeException("not found request attribute "
					+ PassportAttKey);
		return passport;
	}
	 ...
	 * @param passport
	 */
	public static void setLoginedPassport(HttpServletRequest request,
			String passport) {
